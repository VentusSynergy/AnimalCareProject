...
class PetTest {
	...
	void test1() {
		...
		assertEquals("Home", pet.getCustody());
		assertEquals("Max", pet.getUser().getFirstName());
		assertEquals("Rabbit", pet.getSpecies());
		assertEquals("Holland Lop", pet.getBreed());
		assertEquals(false, pet.isFixed());
